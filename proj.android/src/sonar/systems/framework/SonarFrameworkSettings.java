...
public class SonarFrameworkSettings
{
    ...
    public static final boolean USE_TWITTER                   = false; // uses intents for now so no need to include
                                                                       // anything else.

    public static final boolean USE_CHARTBOOST                = false; // Requires Google play services library and
                                                                       // chartboost jar
